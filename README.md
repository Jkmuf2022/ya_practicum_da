...
### 11.[Прогнозирование вероятности оттока пользователей для фитнес-центра](http://localhost:8888/notebooks/yandex-prakticum-projects/11-fitness-center-clients-analysis/11-gym-churn-analytics.ipynb)
